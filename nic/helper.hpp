...
/* Our newly defined */
DECLARE_int32(ioengine_num);
DECLARE_int32(cq_num);
DECLARE_int32(sbuf_size);
DECLARE_int32(rbuf_size);


DECLARE_string(dev);
DECLARE_int32(gid);
DECLARE_int32(io_thread);
DECLARE_int32(recv_sge_size);
