...
// Newly defined
DEFINE_int32(ioengine_num, 5, "Number of IO engines in together");
DEFINE_int32(cq_num, 1, "Number of CQs per IO engine");
DEFINE_int32(sbuf_size, 65536, "Buffer/Message Size");
DEFINE_int32(rbuf_size, 65536, "Buffer/Message Size");


// Control Path parameter
DEFINE_string(dev, "mlx5_0", "ib device to use, default mlx5_0");
DEFINE_int32(gid, 3, "Global id index");
DEFINE_int32(recv_sge_size, 5, "Number of recv sge size");
...
DEFINE_string(mem_nodes,"", "comma separated list of mem node address");
DEFINE_string(trace_file,"test.json", "path of trace file (formatted as test.json)");
DEFINE_int32(io_thread,1, "io_thread count");
DEFINE_string(output_file,"output.txt", "path of output file (formatted as output.txt)");
